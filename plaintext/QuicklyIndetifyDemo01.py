...
# @Author  : QixianZhou
# @FileName: QuicklyIndetifyDemo01.py
...
if __name__ == '__main__':
    ...
    for index, row in messages.iterrows():
        ...
        # 开始预测
        legal_pre = quicklyIdentify(lat,lon,tdoa,grid_real)
        t1 = time.time()
    ...
    print("完成%d条飞机消息合法性的快速认证"%(len(messages)))
    print("TP=",TP)
    print("FP=",FP)
    print("FN=", FN)
    print("TN=", TN)
    ...
    print("在阈值=%d的条件下，各项检测指标为"%THRESHOLD)
