...
# 50m在经度上的距离
deleta_lon_600 = (4.142814-4.13409)
# 50m在纬度上的距离
deleta_lat_600 = (51.833122-51.82773)
...
if __name__ == '__main__':
    ...
    for i in range(int(LENGTH/SQURE_SIZE)):
        #沿着A->B方向
        # 每一行的纬度不变 以A点为起点
        lat = lat_A - i * deleta_lat_600
        for j in range(int(WIDTH/SQURE_SIZE)):
            # 每一行纬度不变 经度递增
             lon = lon_A + j *deleta_lon_600
