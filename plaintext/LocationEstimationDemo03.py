...
if __name__ == '__main__':
    ...
    # 保存数据
    predictError.to_csv("predictError_600m_ns.csv")
    print("打印误差的平均值")
    print("基于600m网格和ns精度，完成%d条消息的位置预测，平均误差为%.2f" % (count, predictError['error'].mean))
